...
* ramsey/uuid-console follows a superset of **[PSR-12 coding standard][psr-12]**.
  Please ensure your code does, too. _Hint: run `composer dev:lint` to check._
* Please **write tests** for any new features you add.
* Please **ensure that tests pass** before submitting your pull request.
  ramsey/uuid-console automatically runs tests for pull requests. However,
...
[github]: https://github.com/ramsey/uuid-console
[issues]: https://github.com/ramsey/uuid-console/issues
[pull requests]: https://github.com/ramsey/uuid-console/pulls
